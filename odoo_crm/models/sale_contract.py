...
class CrmSaleContract(models.Model):
    ...
    delivery_status = fields.Selection(string="发货状态", selection=[('00', '未发货'), ('01', '待发货'), ('02', '已发货')], default='00')
...
class CrmContractCashbackPlan(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', '币种', required=True, default=_default_currency)
    contract_id = fields.Many2one(comodel_name="crm.sale.contract", string="订单合同", required=True)
